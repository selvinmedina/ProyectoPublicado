...
namespace ERP_GMEDINA.Models
{
    ...
    public partial class ERP_GMEDINAEntities : DbContext
    {
        ...
        public virtual ObjectResult<UDP_Plani_tbAcumuladosISR_Insert_Result1> UDP_Plani_tbAcumuladosISR_Insert(string aisr_Descripcion, Nullable<decimal> aisr_Monto, Nullable<int> aisr_UsuarioCrea, Nullable<System.DateTime> aisr_FechaCrea)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<UDP_Plani_tbAcumuladosISR_Insert_Result1>("UDP_Plani_tbAcumuladosISR_Insert", aisr_DescripcionParameter, aisr_MontoParameter, aisr_UsuarioCreaParameter, aisr_FechaCreaParameter);
        }
